describe('Displays the main page with a list of article', () => {
  describe('success', () => {
    ...
    it('displays main page layout', () => {
      ...
      cy.get('[data-cy=breaking-img]').should('have.attr', 'src', 'https://www.kino.dk/sites/default/files/styles/k_width_big/public/primary-pictures/alien_1.jpg?itok=OklM89YT')
      ...
      cy.get('[data-cy=articles-container]').within(() => {
        cy.get('[data-cy=article-card-0]').within(() => {
          ...
          cy.get('[data-cy=image]').should('have.attr', 'src', 'https://media.nature.com/lw800/magazine-assets/d41586-018-05310-x/d41586-018-05310-x_15811194.jpg')
        });
      });
    });
  });
